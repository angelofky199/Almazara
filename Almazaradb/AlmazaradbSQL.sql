...
CREATE TABLE IF NOT EXISTS `almazaradb`.`Molturacion` (
  `idMolturacion` INT NOT NULL COMMENT '',
  `kgOvila` FLOAT NOT NULL COMMENT '',
  ...
  INDEX `fk_Molturacion_Cliente_idx` (`Cliente_idCliente` ASC)  COMMENT '',
  INDEX `fk_Molturacion_Usuario1_idx` (`Usuario_idUsuario` ASC)  COMMENT '',
  CONSTRAINT `fk_Molturacion_Cliente`
...
CREATE TABLE IF NOT EXISTS `almazaradb`.`Compra` (
  ...
  INDEX `fk_Compra_Cliente1_idx` (`Cliente_idCliente` ASC)  COMMENT '',
...
CREATE TABLE IF NOT EXISTS `almazaradb`.`Cambio` (
  ...
  INDEX `fk_Cambio_Cliente1_idx` (`Cliente_idCliente` ASC)  COMMENT '',
  CONSTRAINT `fk_Cambio_Usuario1`
    FOREIGN KEY (`Usuario_idUsuario`)
    REFERENCES `almazaradb`.`Usuario` (`idUsuario`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Cambio_Cliente1`
    FOREIGN KEY (`Cliente_idCliente`)
    REFERENCES `almazaradb`.`Cliente` (`idCliente`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
